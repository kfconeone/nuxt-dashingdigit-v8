...
<template>
  ...
  <div class="hidden xl:block 3xl:hidden">
    <div class="w-full overflow-x-hidden">
      ...
      <div class="flex">
        <div class="w-full min-h-[855px]" style="background: linear-gradient(180deg, #6372c6 0%, #8b90ff 69.03%, #ffffff 88.36%), #6372c6">
          <div class="flex">
            <img class="w-56" src="~assets/imgs/profile/r1.png" />
            <img class="w-56" src="~assets/imgs/profile/r1.png" />
            <img class="w-56" src="~assets/imgs/profile/r1.png" />
            <img class="w-56" src="~assets/imgs/profile/r1.png" />
            <img class="w-56" src="~assets/imgs/profile/r1.png" />
