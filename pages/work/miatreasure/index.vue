...
function initSmoothScrollbarForDesktopAndLaptop() {
  //smooth scrollbar//
  if (!document.querySelector(".pc-mia-scroll")) return;
  const workScroller: any = document.querySelector(".pc-mia-scroll");
  scrollbarRef.value = Scrollbar.init(workScroller, { damping: 0.15, thumbMinSize: 100, delegateTo: document, alwaysShowTracks: false });
  ScrollTrigger.scrollerProxy(".pc-mia-scroll", {
    scrollTop(value) {
      if (arguments.length) {
  ...
  scrollbarRef.value.addListener(({ offset }: any) => {
    var fixedElem = document.getElementById("pc-mia-sticky");
    if (!fixedElem) return;
...
function initSmoothScrollbarForTablet() {
  //smooth scrollbar//
  if (!document.querySelector(".md-mia-scroll")) return;
  const workScroller: any = document.querySelector(".md-mia-scroll");
  ...
  ScrollTrigger.scrollerProxy(".md-mia-scroll", {
    scrollTop(value) {
      if (arguments.length) {
...
function initSmoothScrollbarForMoblie() {
  if (!document.querySelector(".sm-mia-scroll")) return;
  //smooth scrollbar//
  const workScroller: any = document.querySelector(".sm-mia-scroll");
  ...
  ScrollTrigger.scrollerProxy(".sm-mia-scroll", {
    scrollTop(value) {
      if (arguments.length) {
...
<template>
  <div class="hidden xl:block">
    <div class="pc-mia-scroll h-screen">
      <div class="px-10 pt-16 pb-12" :style="{ backgroundImage: `url(${workBg})` }">
        <div class="grid grid-cols-[75%,25%] justify-center gap-3 relative">
          ...
          <div id="pc-mia-sticky" class="bg-white rounded-md px-12 pt-24 pb-40 text-[#262723] h-screen sticky top-0 overflow-scroll">
        ...
        <div class="flex justify-between text-white text-6xl 3xl:text-8xl mt-28 items-center" style="font-family: dgo">
          <NuxtLink class="pointer" href="/work" target="_top">
            <div class="flex gap-4 items-start stroke-white hover:stroke-[#D3E741] hover:text-[#D3E741]">
              <div class="w-[102px]">
                <svg class="" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p ref="pcBackToWork" class="pc-back-to-work">BACK TO WORK</p>
            </div>
          </NuxtLink>
  ...
  <div class="hidden md:block xl:hidden">
    <div class="md-mia-scroll h-screen">
      <div class="px-10 pt-16 pb-12" :style="{ backgroundImage: `url(${workBg})` }">
  ...
  <div class="md:hidden">
    <div class="sm-mia-scroll h-screen">
