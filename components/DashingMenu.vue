        ...
        <div>
          <div>
            ...
            <NuxtLink to="/" target="_top" @click="onClickToggle">
              <p class="text-white 3xl:text-[64px] text-[40px] leading-none pc tracking-wider w-fit ml-8" style="font-family: dgo; text-shadow: -5px 4px 0px #6372c6; text-border: 1px solid #6372c6; -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: #6372c6">HOME</p>
            </NuxtLink>
          </div>
          <div class="mt-20">
            ...
            <NuxtLink to="/work" target="_top" @click="onClickToggle">
              <p class="text-white 3xl:text-[64px] text-[40px] leading-none tracking-wider w-fit ml-8" style="font-family: dgo; text-shadow: -5px 4px 0px #6372c6; text-border: 1px solid #6372c6; -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: #6372c6">WORK</p>
            </NuxtLink>
          </div>
        </div>
        <div>
          ...
          <div class="mt-20">
            ...
            <NuxtLink to="/services" target="_top" @click="onClickToggle">
              <p class="text-white 3xl:text-[64px] text-[40px] leading-none tracking-wider w-fit ml-8" style="font-family: dgo; text-shadow: -5px 4px 0px #6372c6; text-border: 1px solid #6372c6; -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: #6372c6">SERVICES</p>
            </NuxtLink>
          </div>
        </div>
      </div>
